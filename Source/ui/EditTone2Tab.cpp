...
//==============================================================================
EditTone2Tab::EditTone2Tab(Jv880_juceAudioProcessor& p) : audioProcessor (p)
{
...
EditTone2Tab::~EditTone2Tab()
{
}

void EditTone2Tab::updateValues()
{
    Patch* patch = (Patch*) audioProcessor.status.patch;
    Tone tone = patch->tones[1];
...
void EditTone2Tab::visibilityChanged()
{
    updateValues();
}

void EditTone2Tab::resized()
{
    auto top = 30;
...
void EditTone2Tab::sliderValueChanged (juce::Slider* slider)
{
    sendSysexPatchToneChange();
}

void EditTone2Tab::buttonClicked (juce::Button* button)
{
    sendSysexPatchToneChange();
}

void EditTone2Tab::buttonStateChanged (juce::Button* button)
{
}

void EditTone2Tab::comboBoxChanged (juce::ComboBox* button)
{
    sendSysexPatchToneChange();
}

void EditTone2Tab::sendSysexPatchToneChange1(uint32_t address, uint8_t value)
{
      uint8_t data[5];
      data[0] = 0x00; // address MSB
      data[1] = 0x08; // address
      data[2] = 0x28 + 1;  // address
...
void EditTone2Tab::sendSysexPatchToneChange2(uint32_t address, uint8_t value)
{
      uint8_t data[6];
      data[0] = 0x00; // address MSB
      data[1] = 0x08; // address
...
void EditTone2Tab::sendSysexPatchToneChange()
{
