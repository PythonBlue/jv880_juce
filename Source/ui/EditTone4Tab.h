...
/*
*/
class EditTone4Tab  : public juce::Component, public juce::Slider::Listener, public juce::Button::Listener, public juce::ComboBox::Listener
{
public:
    EditTone4Tab(Jv880_juceAudioProcessor&);
    ~EditTone4Tab() override;
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (EditTone4Tab)
};
