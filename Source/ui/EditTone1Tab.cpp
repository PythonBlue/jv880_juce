...
//==============================================================================
EditTone1Tab::EditTone1Tab(Jv880_juceAudioProcessor& p) : audioProcessor (p)
{
...
EditTone1Tab::~EditTone1Tab()
{
}

void EditTone1Tab::updateValues()
{
    Patch* patch = (Patch*) audioProcessor.status.patch;
    Tone tone = patch->tones[0];
...
void EditTone1Tab::visibilityChanged()
{
    updateValues();
}

void EditTone1Tab::resized()
{
    auto top = 30;
...
void EditTone1Tab::sliderValueChanged (juce::Slider* slider)
{
    sendSysexPatchToneChange();
}

void EditTone1Tab::buttonClicked (juce::Button* button)
{
    sendSysexPatchToneChange();
}

void EditTone1Tab::buttonStateChanged (juce::Button* button)
{
}

void EditTone1Tab::comboBoxChanged (juce::ComboBox* button)
{
    sendSysexPatchToneChange();
}

void EditTone1Tab::sendSysexPatchToneChange1(uint32_t address, uint8_t value)
{
      uint8_t data[5];
      data[0] = 0x00; // address MSB
      data[1] = 0x08; // address
      data[2] = 0x28 + 0;  // address
...
void EditTone1Tab::sendSysexPatchToneChange2(uint32_t address, uint8_t value)
{
      uint8_t data[6];
      data[0] = 0x00; // address MSB
      data[1] = 0x08; // address
...
void EditTone1Tab::sendSysexPatchToneChange()
{
