...
/*
*/
class EditTone3Tab  : public juce::Component, public juce::Slider::Listener, public juce::Button::Listener, public juce::ComboBox::Listener
{
public:
    EditTone3Tab(Jv880_juceAudioProcessor&);
    ~EditTone3Tab() override;
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (EditTone3Tab)
};
