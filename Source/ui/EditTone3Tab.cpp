...
//==============================================================================
EditTone3Tab::EditTone3Tab(Jv880_juceAudioProcessor& p) : audioProcessor (p)
{
...
EditTone3Tab::~EditTone3Tab()
{
}

void EditTone3Tab::updateValues()
{
    Patch* patch = (Patch*) audioProcessor.status.patch;
    Tone tone = patch->tones[2];
...
void EditTone3Tab::visibilityChanged()
{
    updateValues();
}

void EditTone3Tab::resized()
{
    auto top = 30;
...
void EditTone3Tab::sliderValueChanged (juce::Slider* slider)
{
    sendSysexPatchToneChange();
}

void EditTone3Tab::buttonClicked (juce::Button* button)
{
    sendSysexPatchToneChange();
}

void EditTone3Tab::buttonStateChanged (juce::Button* button)
{
}

void EditTone3Tab::comboBoxChanged (juce::ComboBox* button)
{
    sendSysexPatchToneChange();
}

void EditTone3Tab::sendSysexPatchToneChange1(uint32_t address, uint8_t value)
{
      uint8_t data[5];
      data[0] = 0x00; // address MSB
      data[1] = 0x08; // address
      data[2] = 0x28 + 2;  // address
...
void EditTone3Tab::sendSysexPatchToneChange2(uint32_t address, uint8_t value)
{
      uint8_t data[6];
      data[0] = 0x00; // address MSB
      data[1] = 0x08; // address
...
void EditTone3Tab::sendSysexPatchToneChange()
{
