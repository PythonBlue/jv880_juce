...
/*
*/
class EditTone1Tab  : public juce::Component, public juce::Slider::Listener, public juce::Button::Listener, public juce::ComboBox::Listener
{
public:
    EditTone1Tab(Jv880_juceAudioProcessor&);
    ~EditTone1Tab() override;
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (EditTone1Tab)
};
